...
import com.ilselva.problems.hackerrank.interview.prepkit.trees.solutions.huffman.HuffmanNode;
...
class HuffmanDecodingTest {
    ...
    void decodeCase0() {
        ...
        Assertions.assertEquals(test, HuffmanDecoding.decode(s.toString(), tree));
    }
